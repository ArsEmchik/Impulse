package blocks
{
	...
	public class ITABlock extends ImpulsUnit
	{
		...
		public function ITABlock()
		{
			...
			ControlDictionary["Белая кнопка"] = button;
			...
			ControlDictionary["ОАК-1 перемычка пер 1"] = jumper1;
			ControlDictionary["ОАК-1 перемычка пр 1"] = jumper2;
			ControlDictionary["ОАК-1 перемычка ТР 1"] = jumper3;
			ControlDictionary["ОАК-1 перемычка ТР 2"] = jumper4;
			ControlDictionary["ОАК-1 перемычка ТР 3"] = jumper5;
			ControlDictionary["ОАК-1 перемычка ТР 4"] = jumper6;
			ControlDictionary["ОАК-1 перемычка ОК 1"] = jumper7;
			ControlDictionary["ОАК-1 перемычка ОК 2"] = jumper8;
			ControlDictionary["ОАК-1 перемычка ОК 3"] = jumper9;
			ControlDictionary["ОАК-1 перемычка ОК 4"] = jumper10;
			ControlDictionary["ОАК-1 перемычка пер 2"] = jumper11;
			ControlDictionary["ОАК-2 перемычка пр 2"] = jumper12;
			ControlDictionary["ОАК-2 перемычка пер 1"] = jumper13;
			ControlDictionary["ОАК-2 перемычка пр 1"] = jumper14;
			ControlDictionary["ОАК-2 перемычка ТР 1"] = jumper15;
			ControlDictionary["ОАК-2 перемычка ТР 2"] = jumper16;
			ControlDictionary["ОАК-2 перемычка ТР 3"] = jumper17;
			ControlDictionary["ОАК-2 перемычка ТР 4"] = jumper18;
			ControlDictionary["ОАК-2 перемычка ОК 1"] = jumper19;
			ControlDictionary["ОАК-2 перемычка ОК 2"] = jumper20;
			ControlDictionary["ОАК-2 перемычка ОК 3"] = jumper21;
			ControlDictionary["ОАК-2 перемычка ОК 4"] = jumper22;
			ControlDictionary["ОАК-2 перемычка пер 2"] = jumper23;
			ControlDictionary["ОАК-2 перемычка пр 2"] = jumper24;
			ControlDictionary["ОАК-3 перемычка пер 1"] = jumper25;
			ControlDictionary["ОАК-3 перемычка пр 1"] = jumper26;
			ControlDictionary["ОАК-3 перемычка ТР 1"] = jumper27;
			ControlDictionary["ОАК-3 перемычка ТР 2"] = jumper28;
			ControlDictionary["ОАК-3 перемычка ТР 3"] = jumper29;
			ControlDictionary["ОАК-3 перемычка ТР 4"] = jumper30;
			ControlDictionary["ОАК-3 перемычка ОК 1"] = jumper31;
			ControlDictionary["ОАК-3 перемычка ОК 2"] = jumper32;
			ControlDictionary["ОАК-3 перемычка ОК 3"] = jumper33;
			ControlDictionary["ОАК-3 перемычка ОК 4"] = jumper34;
			ControlDictionary["ОАК-3 перемычка пер 2"] = jumper35;
			ControlDictionary["ОАК-3 перемычка пр 2"] = jumper36;
			ControlDictionary["ОАК-4 перемычка пер 1"] = jumper37;
			ControlDictionary["ОАК-4 перемычка пр 1"] = jumper38;
			ControlDictionary["ОАК-4 перемычка ТР 1"] = jumper39;
			ControlDictionary["ОАК-4 перемычка ТР 2"] = jumper40;
			ControlDictionary["ОАК-4 перемычка ТР 3"] = jumper41;
			ControlDictionary["ОАК-4 перемычка ТР 4"] = jumper42;
			ControlDictionary["ОАК-4 перемычка ОК 1"] = jumper43;
			ControlDictionary["ОАК-4 перемычка ОК 2"] = jumper44;
			ControlDictionary["ОАК-4 перемычка ОК 3"] = jumper45;
			ControlDictionary["ОАК-4 перемычка ОК 4"] = jumper46;
			ControlDictionary["ОАК-4 перемычка пер 2"] = jumper47;
			ControlDictionary["ОАК-4 перемычка пр 2"] = jumper48;
			ControlDictionary["ОАК-5 перемычка пер 1"] = jumper49;
			ControlDictionary["ОАК-5 перемычка пр 1"] = jumper50;
			ControlDictionary["ОАК-5 перемычка ТР 1"] = jumper51;
			ControlDictionary["ОАК-5 перемычка ТР 2"] = jumper52;
			ControlDictionary["ОАК-5 перемычка ТР 3"] = jumper53;
			ControlDictionary["ОАК-5 перемычка ТР 4"] = jumper54;
			ControlDictionary["ОАК-5 перемычка ОК 1"] = jumper55;
			ControlDictionary["ОАК-5 перемычка ОК 2"] = jumper56;
			ControlDictionary["ОАК-5 перемычка ОК 3"] = jumper57;
			ControlDictionary["ОАК-5 перемычка ОК 4"] = jumper58;
			ControlDictionary["ОАК-5 перемычка пер 2"] = jumper59;
			ControlDictionary["ОАК-5 перемычка пр 2"] = jumper60;
		...
		private function InitializeTrainingSequence()
		{
			...
			AddToTraining(ControlDictionary["Белая кнопка"], "Нажмите и отпустите кнопку КОНТРОЛЬ", ControlElement.S_B_CHOSEN);
